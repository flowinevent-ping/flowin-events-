...
const CSS = `*{margin:0;padding:0;box-sizing:border-box}
  ...
  .pl .x{width:40px;height:40px;border-radius:11px;background:rgba(232,115,12,.16);color:#F59E0B;display:grid;place-items:center;flex-shrink:0}
