...
const CSS = `*{margin:0;padding:0;box-sizing:border-box}
  ...
  .eyebrow{font-size:12.5px;font-weight:800;text-transform:uppercase;letter-spacing:.16em;color:var(--teal);margin-bottom:14px;display:flex;align-items:center;gap:10px}
  .eyebrow::before{content:'';width:26px;height:3px;border-radius:2px;background:var(--teal);flex-shrink:0}
  ...
  .pl .x{width:50px;height:50px;border-radius:14px;background:rgba(232,115,12,.18);color:#F59E0B;display:grid;place-items:center;flex-shrink:0}
  ...
  .bc .bi{width:58px;height:58px;border-radius:16px;display:grid;place-items:center;color:#fff;flex-shrink:0}
  ...
  .kpi .v{font-size:28px;font-weight:900}.kpi .l{font-size:12px;color:rgba(255,255,255,.6);margin-top:6px}
  ...
  .bar{display:flex;align-items:center;gap:12px;margin-bottom:14px;font-size:15px}
  .bar .bl{width:96px;color:rgba(255,255,255,.72);flex-shrink:0}
  .bar .bt{flex:1;height:16px;background:rgba(255,255,255,.06);border-radius:100px;overflow:hidden}
  .bar .bf{display:block;height:100%;border-radius:100px}
  .bar .bn{width:34px;text-align:right;font-weight:800;color:#fff;font-size:14px}
  ...
  .game .gi{width:56px;height:56px;border-radius:16px;display:grid;place-items:center;color:#fff;flex-shrink:0}
  ...
  .price{background:#fff;border:2px solid #cfdaea;border-radius:20px;padding:24px;position:relative;box-shadow:0 10px 30px rgba(20,40,80,.06)}
  ...
  .price .ptag{font-size:13px;color:var(--muted);margin:6px 0 0;line-height:1.5;min-height:34px}
  ...
  .price li{list-style:none;font-size:14px;color:#3a4d63;padding:8px 0;border-top:1px solid var(--line);display:flex;gap:8px;line-height:1.45}
...
@media(min-width:820px){
  ...
  nav,.nav,.topbar,.foot,.footer,.menu{max-width:1080px!important;margin-left:auto!important;margin-right:auto!important}
...
.hero{padding:44px 22px 30px!important}
@media(min-width:820px){
...
const BODY = `<div class="app">
  ...
  <section id="solution">
    ...
    <div class="uses carousel">
      <div class="use"><div class="uh"><span class="ui" style="background:var(--orange)"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg></span>1 · Vous installez Flowin</div><p>Une animation à vos couleurs sur votre lieu ou votre event.</p></div>
      <div class="use"><div class="uh"><span class="ui" style="background:var(--blue)"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="8" ry="3"/><path d="M4 5v6c0 1.7 3.6 3 8 3s8-1.3 8-3V5M4 11v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6"/></svg></span>2 · Vous récupérez une base</div><p>Vos visiteurs jouent, leurs infos entrent dans votre fichier.</p></div>
      <div class="use"><div class="uh"><span class="ui" style="background:var(--teal)"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 4 14h7l-1 8 9-12h-7l1-8z"/></svg></span>3 · Vous passez à l'action</div><p>Insta et Facebook diffusent. Flowin, vous contactez votre base en direct.</p></div>
    </div>
  ...
  <section class="dark" id="benefices">
    ...
    <div class="ben">
      <div class="bc"><div class="bi" style="background:linear-gradient(135deg,var(--blue),#2C49A6)"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="8" ry="3"/><path d="M4 5v6c0 1.7 3.6 3 8 3s8-1.3 8-3V5M4 11v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6"/></svg></div><div><h4>Vous constituez une base client</h4><p>Chaque participant rejoint votre base.</p></div></div>
      <div class="bc"><div class="bi" style="background:linear-gradient(135deg,var(--teal),#138571)"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M19.9 13A8 8 0 1 1 18 7"/><path d="M18 3v4h-4"/></svg></div><div><h4>Vous communiquez en direct</h4><p>Une offre, une actu : vous joignez vos clients directement.</p></div></div>
      <div class="bc"><div class="bi" style="background:linear-gradient(135deg,var(--orange),#C24A03)"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 4 14h7l-1 8 9-12h-7l1-8z"/></svg></div><div><h4>Vous animez votre lieu</h4><p>Vous relancez votre public et faites revenir du monde.</p></div></div>
      <div class="bc"><div class="bi" style="background:linear-gradient(135deg,var(--amber),#C77A06)"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 15l3-3 3 2 5-6"/></svg></div><div><h4>Vous mesurez ce qui compte</h4><p>Affluence, profils, retombées : tout est mesuré.</p></div></div>
    </div>
  </section>
  ...
  <section class="darker" id="superevent">
    ...
    <div class="se-line"><span class="si"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="9" r="5"/><path d="M9 13.5 7.5 21 12 18.5 16.5 21 15 13.5"/></svg></span><p><b>Une visibilité qui attire les sponsors.</b></p></div>
  ...
  <section id="cas">
    ...
    <div class="uses carousel">
      <div class="use"><div class="uh"><span class="ui" style="background:var(--orange)"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><path d="M7 2v8M5 2v6a2 2 0 0 0 4 0V2M7 10v12M16 2c-2 0-3 2-3 5s1 4 3 4v11"/></svg></span>Restaurant &amp; bar</div><p>Constituez une base de clients réguliers et communiquez vos offres en direct.</p></div>
      <div class="use"><div class="uh"><span class="ui" style="background:var(--blue)"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><path d="M6 8h12l-1 12H7zM9 8V6a3 3 0 0 1 6 0v2"/></svg></span>Commerce &amp; boutique</div><p>Transformez le passage en clientèle que vous pouvez relancer.</p></div>
      <div class="use"><div class="uh"><span class="ui" style="background:var(--violet)"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><path d="M3 21h18M5 21V7l6-3 6 3v14"/><path d="M9 21v-4h4v4"/></svg></span>Association</div><p>Animez vos temps forts, gardez le lien avec vos membres et mesurez votre impact pour vos partenaires.</p></div>
      <div class="use"><div class="uh"><span class="ui" style="background:#0B6E4F"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><path d="M3 21h18M3 10 12 4l9 6M5 10v11M19 10v11M10 21v-5h4v5"/></svg></span>Collectivité &amp; tourisme</div><p>Mesurez vos animations et fédérez les acteurs locaux autour d'un même outil.</p></div>
      <div class="use"><div class="uh"><span class="ui" style="background:var(--teal)"><svg class="ic" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><rect x="4" y="5" width="16" height="16" rx="2"/><path d="M4 9.5h16M8 3v3M16 3v3"/></svg></span>Événementiel &amp; salon</div><p>Mesurez la fréquentation réelle et repartez avec une base qualifiée à chaque édition.</p></div>
    </div>
  </section>
  ...
  <section class="dark" id="jeux">
    ...
    <div class="games carousel">
      <div class="game"><div class="gt"><div class="gi" style="background:#0B6E4F"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><circle cx="12" cy="12" r="9"/><path d="M9.4 9a2.6 2.6 0 1 1 3.7 2.4c-.9.4-1.1.9-1.1 1.8"/><path d="M12 16.5h.01"/></svg></div><div><h4>Quiz + bonus</h4><div class="tag">Engagez et sondez</div></div></div><ul><li>Un jeu à votre image qui capte l'attention</li><li>Vous sondez vos visiteurs en même temps</li></ul></div>
      <div class="game"><div class="gt"><div class="gi" style="background:var(--orange)"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><path d="M4 8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2 2 2 0 0 0 0 4 2 2 0 0 1-2 2H6a2 2 0 0 1-2-2 2 2 0 0 0 0-4z"/><path d="M13 6v12" stroke-dasharray="2 2"/></svg></div><div><h4>Tombola</h4><div class="tag">Simple et efficace</div></div></div><ul><li>Vos lots, vos couleurs, en quelques clics</li><li>Tirage et gagnants gérés en un instant, prêts à diffuser</li></ul></div>
      <div class="game"><div class="gt"><div class="gi" style="background:var(--amber)"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><path d="M7 11v8H4a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1z"/><path d="M7 11l4-7a2 2 0 0 1 2 2v3h4.5a2 2 0 0 1 2 2.3l-1 5a2 2 0 0 1-2 1.7H7"/></svg></div><div><h4>Vote live</h4><div class="tag">Immersif et participatif</div></div></div><ul><li>Votre public s'exprime en direct</li><li>Vous récupérez les votes en 1 clic</li></ul></div>
      <div class="game"><div class="gt"><div class="gi" style="background:var(--teal)"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><circle cx="12" cy="8" r="3.4"/><path d="M5 20a7 7 0 0 1 14 0"/></svg></div><div><h4>Quiz solo</h4><div class="tag">Intéressez votre public</div></div></div><ul><li>Chacun joue à son rythme, sans animateur</li><li>Vous suivez les résultats en temps réel</li></ul></div>
      <div class="game"><div class="gt"><div class="gi" style="background:#F97316"><svg class="ic" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.9" stroke-linecap="round"><circle cx="12" cy="9" r="5"/><path d="M9 13.5 7.5 21 12 18.5 16.5 21 15 13.5"/></svg></div><div><h4>Quiz master</h4><div class="tag">Fédérez votre communauté</div></div></div><ul><li>Tout le monde joue ensemble, en direct</li><li>Scores et gagnants gérés automatiquement — un moment fort qui rassemble</li></ul></div>
