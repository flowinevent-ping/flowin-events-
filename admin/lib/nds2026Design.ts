...
/**
 * Surcharges applicatives du parcours NDS 2026.
 *
 * Extrait le 03/09 de NDS2026Client.tsx, ou ce bloc etait ecrit en clair dans
 * le JSX. Il est deplace ICI SANS UNE VIRGULE DE CHANGEMENT (identite md5
 * verifiee) pour une seule raison : le gabarit marque blanche doit pouvoir
 * afficher le parcours tel qu'il est reellement, et non une approximation.
 * NDS2026Client l'importe desormais au lieu de le porter.
 *
 * NDS_CSS pose la charte ; NDS_CSS_APP l'adapte a la page reelle (phone pleine
 * hauteur, ecrans empiles, dock du bas, animations des CTA).
 */
export const NDS_CSS_APP = `        html,body{height:auto !important;min-height:100dvh !important;max-height:none !important;overflow-x:hidden !important;overflow-y:auto !important;display:block !important;padding:0 !important;background:#160820}
...
export const NDS_SPRITE = `<svg width="0" height="0" style="position:absolute" aria-hidden="true">
  ...
  <symbol id="i-heartf" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8Z"/></symbol>
  <symbol id="i-share" viewBox="0 0 24 24"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="m8.6 10.5 6.8-3.9M8.6 13.5l6.8 3.9"/></symbol>
  <symbol id="i-ticket" viewBox="0 0 24 24"><path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/><path d="M13 5v14"/></symbol><symbol id="i-voucher" viewBox="0 0 24 24"><rect x="2" y="6" width="20" height="12" rx="2"/><path d="M14.6 9.7a3 3 0 1 0 0 4.6"/><path d="M8 11.2h4.4"/><path d="M8 12.9h4"/></symbol>
  ...
  <symbol id="i-poster" viewBox="0 0 24 24"><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M8 8h8"/><path d="M8 12h8"/><path d="M8 16h5"/></symbol>
