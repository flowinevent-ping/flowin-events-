...
const ICON_BY_ID: Record<string, string> = {
  ...
  events: 'calendar', 'super-events': 'star', btob: 'target', 'btob-prospects': 'target', landing: 'globe',
  ...
  roadmap: 'map', parametres: 'settings', maintenance: 'wrench', pro: 'layout', 'pro-comptes': 'link', 'pro-gagnants': 'dice', 'pro-crm': 'users', 'pro-tracking': 'target', 'pro-super': 'star', 'pro-events': 'calendar',
}
