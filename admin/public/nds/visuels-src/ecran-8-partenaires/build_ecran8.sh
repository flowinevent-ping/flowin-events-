...
delogo=x=806:y=1603:w=190:h=74:enable='between(t,17.9,27.7)',\
delogo=x=842:y=1746:w=200:h=62:enable='between(t,10.4,18.4)',\
delogo=x=130:y=1435:w=820:h=95:enable='between(t,27.3,34.9)'[b0];\
...
[b3][5:v]overlay=343:1348:enable='between(t,17.9,27.7)'[b4];\
[b4][6:v]overlay=110:592:enable='between(t,27.3,34.9)'[b5];\
[b5][14:v]overlay=137:1462:enable='between(t,27.3,34.9)'[sub];\
