...
INSERT INTO public.pros (id, nom, ville, code_postal, secteur, contact, email, tel) VALUES
  ('pro-test-cannes','TEST Mairie de Cannes','Cannes','06400','Collectivite','Service Animation','test-cannes@flowin.fr','04 97 06 40 00'),
  ('pro-test-antibes','TEST Mairie Antibes','Antibes','06600','Collectivite','Service Animation','test-antibes@flowin.fr','04 92 90 50 00'),
  ('pro-test-grasse','TEST Mairie Grasse','Grasse','06130','Collectivite','Service Animation','test-grasse@flowin.fr','04 97 05 50 00'),
  ('pro-test-nice','TEST Mairie Nice','Nice','06000','Collectivite','Service Animation','test-nice@flowin.fr','04 97 13 20 00'),
  ('pro-test-mougins','TEST Mairie Mougins','Mougins','06250','Collectivite','Service Animation','test-mougins@flowin.fr','04 92 92 50 00')
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.partenaires (id, nom, type, secteur, contact, email, tel, ville, code_postal) VALUES
  ...
  ('part-test-4','TEST Cinema Star','Local','Loisir','Sophie Blanc','sophie@cine-test.fr','04 92 54 16 36','Cannes','06400'),
  ('part-test-5','TEST Restaurant Le Provencal','Local','Restauration','Luc Petit','luc@provencal-test.fr','04 93 38 91 70','Antibes','06600')
ON CONFLICT (id) DO NOTHING;

-- Scénario 1 : 3 jeux Cannes (Quiz, Quiz Solo, Spin)
INSERT INTO public.events (id, pro_id, nom, module, status, date_d, date_f, lieu, couleur, cfg, participants, joueurs_optin, gagnants, client_type) VALUES
  ('ev-test-quiz','pro-test-cannes','TEST Festival Ete Cannes - Quiz','quiz','past','2026-08-01','2026-08-03','Croisette Cannes','#7C2D92','{"qrUrl":"https://flowin-events.vercel.app/parcours/?ev=ev-test-quiz","optinActif":true,"quizNbQuestions":5,"quizScoreMin":3,"quizBonus":true,"quizTimer":30}'::jsonb,3,3,1,'btoc'),
  ('ev-test-quizsolo','pro-test-cannes','TEST Festival Ete Cannes - Quiz Solo','quizsolo','past','2026-08-01','2026-08-03','Croisette Cannes','#F59E0B','{"qrUrl":"https://flowin-events.vercel.app/parcours/?ev=ev-test-quizsolo","optinActif":true,"quizNbQuestions":5,"quizScoreMin":3,"quizTimer":30}'::jsonb,3,3,1,'btoc'),
  ('ev-test-spin','pro-test-cannes','TEST Festival Ete Cannes - Spin','spin','past','2026-08-01','2026-08-03','Croisette Cannes','#EF9F27','{"qrUrl":"https://flowin-events.vercel.app/parcours/?ev=ev-test-spin","optinActif":true,"spinDuration":6,"spinSound":true}'::jsonb,3,3,1,'btoc')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.events (id, pro_id, nom, module, status, date_d, date_f, lieu, couleur, cfg, participants, joueurs_optin, client_type, super_event_id) VALUES
  ...
  ('ev-test-vote','pro-test-cannes','TEST Vote Concerts Riviera','vote','past','2026-09-20','2026-09-20','Plage de Cannes','#3B5CC4','{"voteMode":"stars","qrUrl":"https://flowin-events.vercel.app/parcours/?ev=ev-test-vote","voteChoix":[{"id":"c1","label":"Rock"},{"id":"c2","label":"Jazz"},{"id":"c3","label":"Pop"}],"voteResultatsLive":true}'::jsonb,3,3,'btoc','se-test-vote')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.joueurs (id, email, nom, prenom, tel, ville, code_postal, gains, score_moy, optin, optin_date, last_seen, first_seen, source, events, client_type) VALUES
  ('j-test-q1','test1@flowin.fr','TEST Dupont','Alice','06 11 11 11 11','Cannes','06400',1,'4/4',TRUE,'2026-08-01','2026-08-01','2026-08-01','TEST',ARRAY['ev-test-quiz'],'btoc'),
  ('j-test-q2','test2@flowin.fr','TEST Martin','Bob','06 22 22 22 22','Antibes','06600',0,'3/4',TRUE,'2026-08-01','2026-08-01','2026-08-01','TEST',ARRAY['ev-test-quiz'],'btoc'),
  ('j-test-q3','test3@flowin.fr','TEST Roux','Claire','06 33 33 33 33','Nice','06000',0,'2/4',FALSE,NULL,'2026-08-01','2026-08-01','TEST',ARRAY['ev-test-quiz'],'btoc'),
  ('j-test-s1','test4@flowin.fr','TEST Blanc','David','06 44 44 44 44','Cannes','06400',1,'5/5',TRUE,'2026-08-02','2026-08-02','2026-08-02','TEST',ARRAY['ev-test-quizsolo'],'btoc'),
  ('j-test-s2','test5@flowin.fr','TEST Noir','Emma','06 55 55 55 55','Mougins','06250',0,'4/5',TRUE,'2026-08-02','2026-08-02','2026-08-02','TEST',ARRAY['ev-test-quizsolo'],'btoc'),
  ('j-test-s3','test6@flowin.fr','TEST Vert','Francois','06 66 66 66 66','Grasse','06130',0,'3/5',TRUE,'2026-08-02','2026-08-02','2026-08-02','TEST',ARRAY['ev-test-quizsolo'],'btoc'),
  ('j-test-p1','test7@flowin.fr','TEST Rose','Gabrielle','06 77 77 77 77','Cannes','06400',1,'-',TRUE,'2026-08-03','2026-08-03','2026-08-03','TEST',ARRAY['ev-test-spin'],'btoc'),
  ('j-test-p2','test8@flowin.fr','TEST Or','Hugo','06 88 88 88 88','Vallauris','06220',0,'-',TRUE,'2026-08-03','2026-08-03','2026-08-03','TEST',ARRAY['ev-test-spin'],'btoc'),
  ('j-test-p3','test9@flowin.fr','TEST Argent','Ines','06 99 99 99 99','Antibes','06600',0,'-',TRUE,'2026-08-03','2026-08-03','2026-08-03','TEST',ARRAY['ev-test-spin'],'btoc')
ON CONFLICT (id) DO NOTHING;
